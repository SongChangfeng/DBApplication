...
public class TripItemAddEditActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trip_item_add_edit);

        Intent intent = getIntent();
        int requestCode = intent.getExtras().getInt(GlobalValues.REQUEST_CODE);
        switch (requestCode) {
            case GlobalValues.REQUEST_CODE_TRIP_ITEM_ADD:
                break;

            case GlobalValues.REQUEST_CODE_TRIP_ITEM_EDIT:
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_trip_item_add_edit, menu);
        return true;
    }
